...
class DataReader:
    ...
    Example usage:
        ...
        df, X_train, X_test, y_train, y_test = reader.result
    ...
    def __init__(self, filepath, filename=None, filetype=None,target_column = None,split=False,unsupData=False,df_want = False,test_size=None, random_state=None):
        ...
        # self.run()
        self._result =  None # just to store the result varaible
    ...
    @property
    def result(self):
        """Getter for the data; runs loading logic if it hasn't run yet."""
